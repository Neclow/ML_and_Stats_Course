...
The Shapley value originates in cooperative game theory [@shapley1953]. Its application to machine-learning explanations was introduced by Lundberg and Lee (2017), "A Unified Approach to Interpreting Model Predictions" [@lundberg2017shap], presented at NeurIPS; this paper unified several earlier local explanation methods under the SHAP framework and is the canonical reference. The fast, exact TreeSHAP algorithm for tree ensembles was developed in follow-up work by the same group. For LIME, the original paper is Ribeiro, Singh, and Guestrin (2016), "'Why Should I Trust You?': Explaining the Predictions of Any Classifier" [@ribeiro2016lime], presented at KDD 2016.
