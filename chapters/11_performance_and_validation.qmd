...
cat(
  "  O:E ratio:",
  round(mean(ext_data$death_30d) / mean(ext_data$pred_original), 3),
  "\n"
)
...
cat(
  "  O:E ratio:",
  round(mean(ext_data$death_30d) / mean(ext_data$pred_recalibrated), 3),
  "\n"
)
```
...
val.prob(pred_prob, y_obs, m = 100, cex = 0.5, main = "B. Calibration Plot")
