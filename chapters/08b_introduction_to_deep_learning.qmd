...
%%| eval: true
%%| label: fig-nn-flow
%%| fig-cap: "How a feedforward neural network transforms inputs into a prediction. Each layer takes the previous layer's values, computes weighted sums, and applies a non-linear activation before passing them on."
flowchart LR
  ...
  OUT["Output:<br/>risk probability"]
  I1 --> A1 & A2 & A3
  I2 --> A1 & A2 & A3
  I3 --> A1 & A2 & A3
  A1 --> B1 & B2
