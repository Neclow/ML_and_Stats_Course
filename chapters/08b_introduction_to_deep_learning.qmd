...
%%| eval: true
%%| label: fig-nn-flow
%%| fig-cap: "How a feedforward neural network turns inputs into a prediction. Every input connects to every unit in the next layer, and each connection carries a weight the network learns during training. Values flow left to right; a 'deep' network simply stacks more hidden layers in the middle."
flowchart LR
  I1["Age"]
  I2["Creatinine"]
  I3["Blood<br/>pressure"]
  A1["Hidden layer 1<br/>unit"]
  A2["Hidden layer 1<br/>unit"]
  B1["Hidden layer 2<br/>unit"]
  B2["Hidden layer 2<br/>unit"]
  O["Output:<br/>risk probability"]
  I1 --> A1 & A2
  I2 --> A1 & A2
  I3 --> A1 & A2
  A1 --> B1 & B2
