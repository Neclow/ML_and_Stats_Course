...
print("(a) time-varying treatment            -> IPW / marginal structural model")
print("(b) trust the outcome, not assignment -> g-computation")
print("(c) want a misspecification safety net -> doubly robust (AIPW / TMLE)")
