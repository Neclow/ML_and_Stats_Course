...
Everything uses **clinical data**. Every exercise works in **R and Python**. Pick one or try both. Each exercise has a worked solution you can reveal right beneath it (click **Solution**); the full set is also collected in the [Appendix](appendices/D_exercise_solutions.qmd) for convenience.
...
The **Advanced Research Toolkit** is for after the course --- use it when you are doing your own research and need guidance on causal inference or meta-analysis.
