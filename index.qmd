...
- Build, validate, and report clinical prediction models to current standards
  (TRIPOD+AI)
- Use machine learning methods (random forests, gradient boosting, deep
  learning) and know when they help and when they do not
...
| **Advanced Toolkit** | Causal inference, meta-analysis                                                             |

The **Pre-Course** material should be completed before Day 1 if you are taking
this in person. If you are self-studying, work through everything in order.

The **Advanced Research Toolkit** is for after the course --- use it when you
are doing your own research and need guidance on causal inference or
meta-analysis.

## Am I ready?

Skim Chapters 1-3. If the material feels familiar, skip ahead to Part I. If it
feels new, work through those chapters carefully first — they are the foundation
...
- Smits, van Kuijk & Wynants, _Improving Health Care with Clinical Prediction
  Models_ (2026, CC BY 4.0)
- Van Calster et al., _Lancet Digital Health_ (2025) --- performance measures
  for prediction models
- Lopez-Ayala et al., _BMJ_ (2025) --- handling continuous variables and splines
